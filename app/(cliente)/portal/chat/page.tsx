  ...
  return (
    <div style={{ padding: "24px 24px", maxWidth: 1020, margin: "0 auto", height: "calc(100vh - 48px)", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexShrink: 0 }}>
        <div>
          <h1 style={{ margin: 0, fontSize: "1.25rem", fontWeight: 800, color: "var(--text)", letterSpacing: "-0.02em" }}>Chat</h1>
          <p style={{ margin: "3px 0 0", fontSize: "12.5px", color: "var(--text-faint)" }}>Conversas com o time Fropty via chamados</p>
        </div>
        <Link
      ...
      <div style={{ display: "flex", gap: 14, flex: 1, minHeight: 0 }}>
            ...
            {(!tickets || tickets.length === 0) ? (
              ...
              return (
                <Link
                  ...
                  style={{
                    display: "block", padding: "13px 14px", textDecoration: "none", color: "inherit",
                    borderBottom: i < (tickets?.length ?? 0) - 1 ? "1px solid var(--border)" : "none",
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: "13.5px", fontWeight: 700, color: "var(--text)" }}>Selecione uma conversa</p>
