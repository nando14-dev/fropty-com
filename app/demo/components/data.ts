...
export const INITIAL_PRODUCTS: Product[] = [
  { id: 1, name: "Sonho de Doce de Leite", price: 8, category: "Salgados & Doces", stock: 24, available: true, description: "Sonho artesanal recheado com doce de leite cremoso. Massa fofinha e irresistível.", color: "#EF9F27", image: "https://loremflickr.com/400/300/donut,pastry,sweet" },
  { id: 2, name: "Croissant de Presunto", price: 12, category: "Pães & Croissants", stock: 18, available: true, description: "Croissant folhado recheado com presunto e queijo. Assado na hora, crocante por fora.", color: "#C2783A", image: "https://loremflickr.com/400/300/croissant,bakery,bread" },
  { id: 3, name: "Bolo de Cenoura", price: 45, category: "Bolos & Tortas", stock: 6, available: true, description: "Bolo de cenoura com cobertura de brigadeiro de chocolate. Fatia generosa.", color: "#E85D26", image: "https://loremflickr.com/400/300/cake,chocolate,dessert" },
  { id: 4, name: "Kit Festa (6 un)", price: 42, category: "Kits & Combos", stock: 12, available: true, description: "Kit com 6 mini salgados sortidos: coxinha, bolinha de queijo e risole. Ideal para festas.", color: "#5B57E8", image: "https://loremflickr.com/400/300/snack,food,party" },
  { id: 5, name: "Café Especial 250g", price: 7, category: "Bebidas", stock: 0, available: false, description: "Café torrado e moído especialmente selecionado. Aroma intenso e sabor equilibrado.", color: "#6B4423", image: "https://loremflickr.com/400/300/coffee,espresso,cup" },
  { id: 6, name: "Pão de Queijo (10 un)", price: 18, category: "Pães & Croissants", stock: 30, available: true, description: "Pão de queijo artesanal com polvilho azedo e queijo minas. Crocante por fora, mole por dentro.", color: "#D4A837", image: "https://loremflickr.com/400/300/bread,cheese,baked" },
  { id: 7, name: "Torta de Frango", price: 38, category: "Bolos & Tortas", stock: 8, available: true, description: "Torta recheada com frango desfiado, catupiry e milho. Massa crocante e recheio cremoso.", color: "#4A90D9", image: "https://loremflickr.com/400/300/pie,chicken,food" },
  { id: 8, name: "Brownie de Chocolate", price: 9, category: "Salgados & Doces", stock: 20, available: true, description: "Brownie denso e fudgy com chocolate belga 70%. Levemente crocante por fora.", color: "#3D2010", image: "https://loremflickr.com/400/300/brownie,chocolate,dessert" },
];
